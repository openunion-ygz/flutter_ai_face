...
//    [self.view addSubview:liveScoreLabel];
    ...
    btnFirst.frame = CGRectMake((ScreenWidth-260) / 2, 452, 260, 44);
    ...
    btnSecond.frame = CGRectMake((ScreenWidth-260) / 2, 516, 260, 44);
    ...
    labelFirst.frame = CGRectMake((ScreenWidth-72) / 2, 465, 72, 18);
