...
A new Flutter plugin.
  ...
  #引入百度ai平台license
  s.source_files = 'Classes/**/*','BDFaceSDK/idl-license.face-ios','BDFaceSDK/idl-key.face-ios','BDFaceSDK/**/*'
  #引入头文件
  ...
  s.resources = 'Assets/**/*',"BDFaceSDK/*.bundle","BDFaceSDK/com.baidu.idl.face.faceSDK.bundle","BDFaceSDK/com.baidu.idl.face.live.action.image.bundle","BDFaceSDK/com.baidu.idl.face.model.faceSDK.bundle"
